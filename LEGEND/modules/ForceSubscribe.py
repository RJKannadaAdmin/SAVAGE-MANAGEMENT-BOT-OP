            ...
            if chat_member.restricted_by.id == (client.get_me()).id:
                try:
                    ...
                    client.answer_callback_query(
                        cb.id,
                        text=f"❗ Hey Join @{channel} channel and press 'UnMute Me' button.",
                        show_alert=True,
                    )
            else:
                client.answer_callback_query(
            ...
            try:
                ...
                try:
                    sent_message = message.reply_text(
                        "ಕ್ಷಮಿಸಿ {} 🙏 \n \n**ನೀವು ಇನ್ನು ನಮ್ಮ @{} ಗೆ ಸೇರಿಕೊಂಡಿಲ್ಲ** 😭 \n \nದಯವಿಟ್ಟು ನಮ್ಮ [Channel](https://t.me/{}) ಸೇರಿಕೊಳ್ಳಿ ಮತ್ತು \n \n ಕೆಳಗೆ ಕಾಣುತ್ತಿರುವ **UNMUTE ME** ಬಟನ್ ಕ್ಲಿಕ್ ಮಾಡಿ. \n \n ".format(
